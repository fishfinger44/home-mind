...
- ⚠️ Zostaje drobna skaza gramatyczna: model bywa odmienia minuty jak liczebnik porządkowy („dwudziestej trzeciej **czterdziestej pięć**", „dwudziestą pierwszą **dziewiętnastą**") zamiast głównego. Cyfr nie ma, więc cel osiągnięty, ale to jest dokładnie ten przypadek, w którym wersja liczona w kodzie byłaby bezbłędna.
